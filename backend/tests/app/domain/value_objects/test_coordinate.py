...
def test_to_float_tupleメソッドが正しく動作すること() -> None:
...
def test_同じ値のCoordinateが等しいこと() -> None:
...
def test_異なる値のCoordinateが等しくないこと() -> None:
