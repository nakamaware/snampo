...
class TestStreetViewImage:
    ...
    def test_同じ値のStreetViewImageが等しいこと(self) -> None:
    ...
    def test_異なる値のStreetViewImageが等しくないこと(self) -> None:
    ...
    def test_空の画像データで作成できること(self) -> None:
    ...
    def test_同じ座標でも画像データが異なれば異なるオブジェクトになること(self) -> None:
