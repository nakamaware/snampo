...
def test_to_stringメソッドが正しく動作すること() -> None:
...
def test_同じ値のImageSizeが等しいこと() -> None:
...
def test_異なる値のImageSizeが等しくないこと() -> None:
...
def test_無効な幅値でValidationErrorが発生すること() -> None:
...
def test_無効な高さ値でValidationErrorが発生すること() -> None:
