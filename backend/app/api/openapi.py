...
def custom_openapi(app: FastAPI) -> dict:
    ...
    # NOTE: FastAPIのデフォルトのValidationErrorスキーマでは、locが Union[int, str] の配列として
    #       定義されているが、Dartクライアントコード生成ツール (openapi-generator) が
    #       List<String> として生成するため、型の一貫性を保つために明示的に list[str] として定義
